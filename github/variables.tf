...
{ name = "marketing_recommender", owning_teams = ["Terraform-Admins"], status_checks_main = ["lint", "test"], description = "Project that aims to generate a recommendation system for marketing strategy." }
  ]
